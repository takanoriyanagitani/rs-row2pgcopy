...
use row2pgcopy::time::primitive::Timestamp;
    ...
    W: io::Write,
{
    ...
    let rows = vec![
        Row {
            created: Timestamp::try_from("1970-01-01T00:00:00.0Z").unwrap(),
        },
        Row {
            created: Timestamp::try_from("1970-01-01T00:00:00.1Z").unwrap(),
        },
        Row {
            created: Timestamp::try_from("2024-01-17T13:55:51.0Z").unwrap(),
        },
    ];
